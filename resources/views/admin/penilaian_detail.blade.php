                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <div class="container">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="date" name="tanggal_lahir" class="form-control" id="" readonly
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="fakultasi" class="form-control"
                                                value="{{$profile->fakultasi}}" readonly>
                                        </div>
                                        <div class="mb-3">
                                            <label for="" class="form-label">Alamat Kampus</label>
                                            <input type="text" name="alat_kampus" class="form-control" readonly
                                                value="{{$profile->alat_kampus}}">
                                        </div>
                                        <div class="mb-3">
                                            <label for="" class="form-label">Waktu Awal Magang</label>
                                            <input type="date" name="start_magang" class="form-control" readonly
                                                value="{{$profile->start_magang}}">
                                        </div>
                                        <div class="mb-3">
                                            <label for="" class="form-label">Waktu Akhir Magang</label>
                                            <input type="date" name="selesai_magang" class="form-control" readonly
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="number" name="no_telpon" class="form-control" readonly
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <form action="{{route('admin.penilaian.post',$user->id)}}" method="post">
                                            @csrf
                                        <div class="mb-3">
