                                    ...
                                    <tbody>
                                        @foreach ($user as $u)
                                            <tr>
                                                ...
                                                <td>
                                                    @if ($u->is_confirmation==0)
                                                       <span class="text-danger"> Belum Konfirmasi</span>
                                                        @else
                                                        <span class="text-success"> Sudah Konfirmasi</span>
                                                    @endif
                                                </td>
                                                <td>
                                                    @if ($u->is_confirmation==0)
                                                    <a href="{{route('admin.konfirmasi_status',$u->id)}}" class="btn btn-primary">Konfirmasi</a>
                                                    @else
                                                    -
                                                    @endif
