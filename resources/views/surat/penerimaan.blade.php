...
<body>
  ...
  <table width="100%" style="margin-top: 30px;">
    <tr>
      <td align="left">
       Dengan ini memberikan ijin untuk melakukan kegiatan magang pada tanggal <b>{{date("d-m-Y", strtotime($profile->start_magang))}}</b> Sampai <b>{{date("d-m-Y", strtotime($profile->selesai_magang))}}</b> 
      </td>
    </tr>
    <tr>
